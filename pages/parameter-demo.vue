<template>
  <div class="parameter-demo">
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-3xl font-bold text-center mb-8">参数设置组件演示</h1>
      ...
      <div class="mt-8 p-6 bg-gray-50 rounded-lg">
        <h2 class="text-xl font-semibold mb-4">当前参数</h2>
      ...
      <div v-if="generationResult" class="mt-8 p-6 bg-green-50 rounded-lg">
        <h2 class="text-xl font-semibold mb-4 text-green-800">生成结果</h2>
